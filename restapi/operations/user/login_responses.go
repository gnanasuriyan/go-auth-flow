...
// WithXRateLimit adds the xRateLimit to the login o k response
func (o *LoginOK) WithXRateLimit(xRateLimit int32) *LoginOK {
	o.XRateLimit = xRateLimit
	return o
}

// SetXRateLimit sets the xRateLimit to the login o k response
func (o *LoginOK) SetXRateLimit(xRateLimit int32) {
	o.XRateLimit = xRateLimit
}
